...
![OmniPay Logo](/public/omnipay-logo.png)

Modern cross-chain payment platform with premium UI and Web3 integration.
...
OmniPay Frontend is built with type safety, scalability, and developer experience in mind. A comprehensive Web3 payment platform built on modern React technologies.

## Features

- **Cross-Chain Payments**: Support for multiple blockchain networks (Ethereum, Polygon, Arbitrum, Optimism, Base)
- **Smart Contract Integration**: Direct integration with OmniPay smart contracts
- **Wallet Connection**: Rainbow SDK integration with support for major wallets
- **Premium UI**: Modern design with animations and responsive layout
- **Payment Types**: 
  - Instant ETH/ERC20 payments
  - Recurring subscriptions
  - Cross-chain bridge transfers
  - Batch settlement processing
- **Developer Experience**: TypeScript, ESLint, Prettier, and comprehensive testing
...
- [Rainbow SDK](https://www.rainbowkit.com) - Wallet connection library
